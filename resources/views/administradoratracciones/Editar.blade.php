                    ...
                    <form novalidate role="form" name="multimediaForm">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <file-input text="previewImagenesText" ng-model="imagenes" preview="previewImagenes" accept="image/*" icon-class="glyphicon glyphicon-plus" id-input="imagenes" label="Seleccione las imágenes de la atracción." multiple max-files="20"></file-input>
