...
@section('content')
    <div ng-controller="publicacionCrearCtrl" >
        ...
        <form role="form" name="formCrear" novalidate>
              ...
              <div class = "row">
                    <div class="col-md-6  col-xs- 6 col-sm-6">
                          <label>Titulo</label>
                          <input type="text" name="titulo" class="form-control" ng-model="publicacion.titulo" placeholder="Titulo" required/>
                          <span ng-show= "formCrear.$submitted || formCrear.titulo.$touched">
                              <span ng-show="formCrear.titulo.$error.required">* El campo es obligatorio.</span>
                        ...
                        <div class="col-md-6  col-xs- 6 col-sm-6">
                              ...
                              <select ng-model="publicacion.tipos_publicaciones_obras_id" name="tipo" style="width:100%" class="form-control" ng-options="tipo.id as tipo.nombre for tipo in tipos" ng-required="true">
                                ...
                                <span ng-show="formCrear.$submitted || formCrear.tipo.$touched">
                                    
                                    <span class="label label-danger" ng-show="formCrear.tipo.$error.required">Debe seleccionar un tipo de publicación</span>
                                </span>                                         
                        </div>
              ...
              <div class="row" >
                    ...
                    <div class="form-group" >
                        ...
                        <ui-select multiple ng-model="publicacion.temas" theme="bootstrap">
                        ...
                        <span ng-show="formCrear.$submitted">
                            <span class="label label-danger" ng-show="formCrear.$submitted && publicacion.temas.length == 0 ">Debe seleccionar un tipo de publicación</span>
                        </span>          
                    </div>
                </div>
                        ...
                        <tr  ng-repeat = "persona in publicacion.personas">
                          <td>     
                                <input type="email" name="email@{{$index}}" class="form-control" ng-model="persona.email" ng-change="buscarPersona(persona)" required/>
                                    <span ng-show= "formCrear.$submitted || formCrear.email@{{$index}}.$touched">
                                    <span ng-show="formCrear.email@{{$index}}.$error.required">* El campo es obligatorio.</span>
                                    <span ng-show="formCrear.$submitted || formCrear.email@{{$index}}.$touched && formCrear.email@{{$index}}.$error.email">No es un correo válido</span>
                            </span></td>
                          <td> 
                          <input type="text" name="nombre@{{$index}}" class="form-control" ng-model="persona.nombres" required/>
                              <span ng-show= "formCrear.$submitted || formCrear.nombre@{{$index}}.$touched">
                                   <span ng-show="formCrear.nombre@{{$index}}.$error.required">* El campo es obligatorio.</span>
                                          </span>
                        </td>
                        <td>
                                 <input type="text" name="apellido@{{$index}}" class="form-control" ng-model="persona.apellidos" required/>
                                  <span ng-show= "formCrear.$submitted || formCrear.apellido@{{$index}}.$touched">
                                  <span ng-show="formCrear.apellido@{{$index}}.$error.required">* El campo es obligatorio.</span>
                                  </span>
                         ...
                         <td>
                                   <select ng-model="persona.paises_id" name="pais@{{$index}}" style="width:100%" class="form-control" ng-options="pais.id as pais.nombre for pais in paises" ng-required="true">
                                    <option value="" disabled>Seleccione un pais</option>
                                            ...
                                            <span ng-show="formCrear.$submitted || formCrear.pais@{{$index}}.$touched">
                                                
                                                <span class="label label-danger" ng-show="formCrear.pais@{{$index}}.$error.required">Debe seleccionar un pais</span>
                                            </span>                      
                         </td>
                         <td>
            ...
            <input type="submit"  class="btn btn-success" value="Guardar"  ng-click="agregarPublicacion()">
        </div>
        </form>
