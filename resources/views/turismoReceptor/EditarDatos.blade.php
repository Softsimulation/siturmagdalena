    ...
    <form role="form" name="DatosForm" novalidate>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <select class="form-control" name="encuestador" ng-options="item.id as item.asp_net_user.nombre for item in encuestadores" ng-model="encuesta.Encuestador" ng-required="true">
