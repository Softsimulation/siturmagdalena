...
<html lang="es">
    ...
    <body ng-app="sostenibilidadHogar">
        <div id="preloader">
            <div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-9">
                            <h1 style="margin-top: 0.8em; font-size: 2em"><strong>SOSTENIBILIDAD DE LAS ACTIVIDADES TURÍSTICAS- HOGARES</strong></h1>
                        </div>
        ...
        <script src="{{asset('/js/encuestas/sostenibilidadHogar/encuesta.js')}}"></script>
