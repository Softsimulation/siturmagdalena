                    ...
                    <ul role="menubar">
                        ...
                        <li>
                            ...
                            <ul role="menu" id="menuOfertaEmpleo" aria-label="Oferta y empleo">
                                ...
                                <li role="none"><a role="menuitem" href="{{asset('ofertaempleo/encuesta/1')}}">Alojamiento</a></li>
        					    <li role="none"><a role="menuitem" href="{{asset('ofertaempleo/encuesta/2')}}">Restaurante</a></li>
        					    <li role="none"><a role="menuitem" href="{{asset('ofertaempleo/encuesta/3')}}">Agencia de operadores</a></li>
        					    <li role="none"><a role="menuitem" href="{{asset('ofertaempleo/encuesta/4')}}">Agencia de viajes</a></li>
        					    <li role="none"><a role="menuitem" href="{{asset('ofertaempleo/encuesta/5')}}">Alquiler de vehículos</a></li>
        					    <li role="none"><a role="menuitem" href="{{asset('ofertaempleo/encuesta/6')}}">Transporte</a></li>
        					</ul>
                        </li>
                        <li>
                            ...
                            <ul role="menu" id="menuSostenibilidad" aria-label="Sostenibilidad">
                                <li role="none">
                                    ...
                                    <a role="menuitem" href="{{asset('sostenibilidadhogares/PST')}}">PST</a>
                                </li>
                            </ul>
                        </li>
                        <li>
