...
<html lang="es">
    ...
    <body ng-app="encuestaSostenibilidadPst">
        <div id="preloader">
            <div>
                        ...
                        <div class="col-xs-12 col-md-1">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="/periodoSostenibilidadPst/listado">Volver</a></li>
        ...
        <script src="{{asset('/js/encuestas/sostenibilidadPst/main.js')}}"></script>
