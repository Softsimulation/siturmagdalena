...
<body ng-app="appEncuestaDinamicaPublic" <?php echo $__env->yieldContent('Control'); ?>>
    <div id="preloader">
        <div>
    ...
    <header>
        ...
        <div class="progress progress-striped active">
            <div class="progress-bar progress-bar-info" style="width:<?php echo e(isset($porcentaje) ? $porcentaje : 0); ?>%"> <?php echo e(isset($nunSeccion) ? $nunSeccion : 0); ?> </div>
        </div>
    </header>
    <div class="container" >
    ...
    <script src="<?php echo e(asset('/js/encuestas/dinamica/directiva.campos.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/encuestas/dinamica/serviPublic.js')); ?>"></script>
    <script src="<?php echo e(asset('/js/encuestas/dinamica/appPublic.js')); ?>"></script>
