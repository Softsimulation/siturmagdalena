<?php $__env->startSection('title', 'Listado de departamentos'); ?>
...
<?php $__env->startSection('TitleSection', 'Listado de departamentos'); ?>

<?php $__env->startSection('Progreso', '0%'); ?>

<?php $__env->startSection('NumSeccion', '0%'); ?>

<?php $__env->startSection('app', 'ng-app="departamentosApp"'); ?>

<?php $__env->startSection('controller','ng-controller="departamentosController"'); ?>
...
<script src="<?php echo e(asset('/js/administrador/departamentos/departamentosController.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/departamentos/services.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/departamentos/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>
