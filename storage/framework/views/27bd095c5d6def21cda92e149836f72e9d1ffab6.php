<?php $__env->startSection('Title','Duración de la estancia y lugares visitados - Encuesta interno y emisor :: SITUR Atlántico'); ?>
...
<?php $__env->startSection('TitleSection','Actividades Realizadas'); ?>
<?php $__env->startSection('Progreso','40%'); ?>
<?php $__env->startSection('NumSeccion','40%'); ?>
<?php $__env->startSection('Control','ng-controller="estancia"'); ?>
...
<div class="main-page" ng-controller="estancia">
    ...
    <form role="form" name="EstanciaForm" novalidate>
        ...
        <div class="row" style="text-align:center">
            <a href="/turismointerno/viajesrealizados/<?php echo e($idpersona); ?>" class="btn btn-raised btn-default">Anterior</a>
