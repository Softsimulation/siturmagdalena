<?php $__env->startSection('title', 'Listado de atracciones'); ?>
...
<?php $__env->startSection('TitleSection', 'Listado de atracciones'); ?>

<?php $__env->startSection('Progreso', '0%'); ?>

<?php $__env->startSection('NumSeccion', '0%'); ?>

<?php $__env->startSection('app', 'ng-app="atraccionesApp"'); ?>

<?php $__env->startSection('controller','ng-controller="atraccionesIndexController"'); ?>
...
<script src="<?php echo e(asset('/js/administrador/atracciones/indexController.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/atracciones/crearController.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/atracciones/editarController.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/atracciones/idiomaController.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/atracciones/services.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/atracciones/app.js')); ?>"></script>
<script src="https://maps.google.com/maps/api/js?libraries=placeses,visualization,drawing,geometry,places"></script>
<script src="<?php echo e(asset('/js/plugins/gmaps.js')); ?>"></script>
<script src="<?php echo e(asset('/js/plugins/directiva-tigre.js')); ?>"></script>
<?php $__env->stopSection(); ?>
