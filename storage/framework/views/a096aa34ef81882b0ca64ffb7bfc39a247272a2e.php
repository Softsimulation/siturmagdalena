<?php $__env->startSection('title', 'Listado de países'); ?>
...
<?php $__env->startSection('TitleSection', 'Listado de países'); ?>

<?php $__env->startSection('Progreso', '0%'); ?>

<?php $__env->startSection('NumSeccion', '0%'); ?>

<?php $__env->startSection('app', 'ng-app="paisesApp"'); ?>

<?php $__env->startSection('controller','ng-controller="paisesController"'); ?>
...
<script src="<?php echo e(asset('/js/administrador/paises/paisesController.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/paises/services.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/paises/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>
