<?php $__env->startSection('Title','Viajes realizados - Encuesta interno y emisor :: SITUR Madgalena'); ?>
...
<?php $__env->startSection('TitleSection','Viajes realizados'); ?>
<?php $__env->startSection('Progreso','20%'); ?>
<?php $__env->startSection('NumSeccion','20%'); ?>
<?php $__env->startSection('Control','ng-controller="viajes"'); ?>
...
<div class="main-page" ng-controller="viajes">
    ...
    <div class="alert alert-danger" ng-if="error != nul">
        <label><b><?php echo e(trans('Encuesta MsgError')); ?>:</b></label>
        <br />
        <div>
            {{error}}
        </div>
   ...
   <div ng-show="ver">
    ...
    <div class="row">
        <div class="col-xs-12" style="text-align: center; border-top: .5px solid lightgrey">
            <a href="/turismointerno/editarhogar/<?php echo e($hogar); ?>" class="btn btn-raised btn-default" placeholder="Anterior">Anterior</a>
