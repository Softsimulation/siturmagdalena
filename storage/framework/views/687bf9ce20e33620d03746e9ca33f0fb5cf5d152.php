<?php $__env->startSection('title', 'Listado de municipios'); ?>
...
<?php $__env->startSection('TitleSection', 'Listado de municipios'); ?>

<?php $__env->startSection('Progreso', '0%'); ?>

<?php $__env->startSection('NumSeccion', '0%'); ?>

<?php $__env->startSection('app', 'ng-app="municipiosApp"'); ?>

<?php $__env->startSection('controller','ng-controller="municipiosController"'); ?>
...
<script src="<?php echo e(asset('/js/administrador/municipios/municipiosController.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/municipios/services.js')); ?>"></script>
<script src="<?php echo e(asset('/js/administrador/municipios/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>
