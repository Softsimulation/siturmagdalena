...
<?php $__env->startSection('Title','Administrador de temporadas :: SITUR Magdalena'); ?>
...
<?php $__env->startSection('controller','ng-controller="temporadasCtrl"'); ?>
...
<?php $__env->stopSection(); ?>
 <?php $__env->startSection('javascript'); ?>
        <script src="<?php echo e(asset('/js/plugins/list.js')); ?>"></script>
    
    
        <script src="<?php echo e(asset('/js/plugins/moment-with-locales.js')); ?>"></script>
        <script src="<?php echo e(asset('/js/plugins/bootstrap-datetimepicker.js')); ?>"></script>
        <script src="<?php echo e(asset('/js/plugins/bootstrap-slider.js')); ?>"></script>
