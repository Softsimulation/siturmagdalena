<?php $__env->startSection('Title','Gastos - Turísmo interno y emisor :: SITUR'); ?>
...
<?php $__env->startSection('Progreso','80%'); ?>
<?php $__env->startSection('NumSeccion','80%'); ?>
<?php $__env->startSection('Control','ng-controller="gastos"'); ?>
    ...
    <div class="main-page" >
        ...
        <form role="form" name="GastoForm" novalidate>
            ...
            <div class="row" style="text-align:center">
                <a href="/turismointerno/transporte/<?php echo e($id); ?>" class="btn btn-raised btn-default"><?php echo e(trans('resources.EncuestaBtnAnterior')); ?></a>
                <input type="submit" class="btn btn-raised btn-success" ng-click="guardar()" value="<?php echo e(trans('resources.EncuestaBtnSiguiente')); ?>" />
            </div>
            <br />
    </form>
