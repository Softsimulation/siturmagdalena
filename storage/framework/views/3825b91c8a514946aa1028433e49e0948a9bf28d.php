@{
    ViewBag.Title = "Fuentes de información - Turísmo interno y emisor :: SITUR";
...
@{
    ViewBag.TitleSection = "Fuentes de información";

}
@{
    ViewBag.Progreso = "100%";
    ViewBag.NumSeccion = "100%";
}

<div class="main-page" ng-controller="fuentesInterno">
    ...
    <div class="alert alert-danger" ng-if="errores != null">
        ...
        <div ng-repeat="error in errores" ng-if="error.errores.length>0">
            -<?php echo e(error.errores[0].ErrorMessage); ?>
    ...
    <form role="form" name="inForm" novalidate>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="checkbox" ng-repeat="it in fuentesAntes">
                            <label>
                                <input type="checkbox" name="fuentesAntes" checklist-model="enteran.FuentesAntes" checklist-value="it.Id" ng-change="validar(2, it.Id)"> <?php echo e(it.Nombre); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="checkbox" ng-repeat="it in fuentesDurante">
                            <label>
                                <input type="checkbox" name="fuentesDurante" checklist-model="enteran.FuentesDurante" ng-disabled="(enteran.FuentesDurante.indexOf(13) > -1 && it.Id!=13)" ng-change="validar(0, it.Id)" checklist-value="it.Id"> <?php echo e(it.Nombre); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="checkbox" ng-repeat="it in redes" style="margin-bottom: .5em;">
                            <label>
                                <input type="checkbox" name="redes" checklist-model="enteran.Redes" ng-disabled="enteran.Redes.indexOf(1) > -1 && it.Id != 1" ng-change="validar(1, it.Id)" checklist-value="it.Id"> <?php echo e(it.Nombre); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr ng-repeat="e in experiencias" ng-if="$index <= 3">
                                    <td><?php echo e(e.Nombre); ?> <span ng-show="inForm.$submitted && inForm.calificacion_<?php echo e(e.Id); ?>.$error.required">(Requerido)</span></td>
                                    <td ng-repeat="c in calificaciones" style="text-align:center">
                                        <div class="radio radio-primary" style="display: inline-block; margin:0">
                                            <label>
                                                <input type="radio"  name="calificacion_<?php echo e(e.Id); ?>" ng-model="e.Valor" value="<?php echo e(c.Id); ?>" ng-required="true">
                                            </label>
                                        </div>
                                    </td>
                                    <td style="text-align:center">
                                        <div class="radio radio-primary" style="display: inline-block; margin:0">
                                            <label>
                                                <input type="radio" name="calificacion_<?php echo e(e.Id); ?>" ng-model="e.Valor" value="-1" ng-required="true" />
                                            </label>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="row" style="text-align:center">
            <a href="/EncuestaInterno/Gastos/<?php echo e(id); ?>" class="btn btn-raised btn-default">@Resource.EncuestaBtnAnterior</a>
