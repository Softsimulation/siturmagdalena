<?php $__env->startSection('Title','Transporte utilizado - Encuesta interno y emisor :: SITUR Atlántico'); ?>
...
<?php $__env->startSection('TitleSection','Transporte utilizado'); ?>
<?php $__env->startSection('Progreso','60%'); ?>
<?php $__env->startSection('NumSeccion','60%'); ?>
<?php $__env->startSection('Control','ng-controller="transporte"'); ?>
...
<div class="main-page">
    ...
    <form role="form" name="transForm" novalidate>
        ...
        <div class="row" style="text-align:center">
            <a href="#" class="btn btn-raised btn-default"><?php echo e(trans('resources.EncuestaBtnAnterior')); ?></a>
