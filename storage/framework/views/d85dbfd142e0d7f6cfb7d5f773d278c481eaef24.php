...
<?php $__env->startSection('TitleSection', "Crear periodo" ); ?>
<?php $__env->startSection('app','ng-app="appMuestraMaestra"'); ?>
<?php $__env->startSection('controller','ng-controller="CrearPeriodoCtrl"'); ?>


<?php $__env->startSection('content'); ?>
   
    <input type="hidden" id="periodo" value="<?php echo e($ultipoPeriodoID); ?>" />
