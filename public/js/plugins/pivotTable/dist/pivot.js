(function () {
    ...
    callWithJQuery(function ($) {
        ...
        aggregatorTemplates = {
            ...
            promedioSitur: function (formatter) { //Hecha por Andres Paternina
                if (formatter == null) {
                    formatter = usFmt;
                }
                return function (arg) {
                        ...
                        return {
                            ...
                            push: function (record) {
                                if (!isNaN(parseFloat(record[attr]))) {
                                    this.sumapromedio += record["Cantidad"] * record["Cantidad_Datos"];
                                    this.sumapersonas += record["Cantidad_Datos"];
                                }
                            },
                            value: function () {
                                return this.sumapromedio / this.sumapersonas;
                            },
                            format: formatter,
                            numInputs: attr != null ? 0 : 1
                        };
            ...
            promedioDia: function (formatter) { //Hecha por Andres Paternina
                if (formatter == null) {
                    formatter = usFmt;
                }
                return function (arg) {
                    ...
                    return function (data, rowKey, colKey) {
                        return {
                            ...
                            push: function (record) {
                                if (!isNaN(parseFloat(record[attr]))) {
                                    this.sumapromedio += record["Cantidad_Dia"] * record["Cantidad_Datos"];
                                    this.sumapersonas += record["Cantidad_Datos"];
                                }
                            },
                            value: function () {
            ...
            proporcionSitur: function (formatter) { //Hecha por Brayan Carbono
                if (formatter == null) {
                    formatter = usFmtPct;
                }
                return function (arg) {
                    ...
                    return function (data, rowKey, colKey) {
                        return {
                            ...
                            denominador: 0,
                            push: function (record) {
                                if (!isNaN(parseFloat(record["Cantidad"])) && !isNaN(parseFloat(record["Cantidad_Datos"]))) {
                                    this.numerador += record["Cantidad"];
                                    this.denominador += record["Cantidad_Datos"];
                                }
                            },
                            value: function () {
            ...
            viajesSitur: function (formatter) { //Hecha por Brayan Carbono 
                ...
                return function (arg) {
                    ...
                    return function (data, rowKey, colKey) {
                        return {
                            ...
                            tasaRNT: 0,
                            push: function (record) {
                                if (!isNaN(parseFloat(record["Cantidad"])) && !isNaN(parseFloat(record["Tasa"]))) {
                                    this.suma += record["Cantidad"];
                                    this.tasaRNT = record["Tasa"];
                                }
                            },
                            value: function () {
                                return this.suma * this.tasaRNT;
                            },
                            format: formatter,
                            numInputs: attr != null ? 0 : 1
                        };
            ...
            porcentajeSitur: function (formatter) { //Hecha por Jenn 
                ...
                return function (arg) {
                    ...
                    return function (data, rowKey, colKey) {
                        return {
                            ...
                            tasaRNT: 0,
                            push: function (record) {
                                if (!isNaN(parseFloat(record["Cantidad"]))) {
                                    this.suma += record["Cantidad"];
                                }
                            },
                            value: function () {
        ...
        locales = {
            en: {
                ...
                localeStrings: {
                    ...
                    tooMany: "(Demasiados registros a listar)",
                    filterResults: "Valores filtros",
                    apply: "Aplicar",
                    cancel: "Cancelar",
                    totals: "Totales",
                    vs: "vs",
