(function() {
  ...
  callWithJQuery(function($, c3) {
    ...
    return $.pivotUtilities.c3_renderers = {
      "Barras horizontales": makeC3Chart({
        type: "bar",
        horizontal: true
      }),
      "Barras horizontales apiladas": makeC3Chart({
        type: "bar",
        stacked: true,
        horizontal: true
      }),
      ...
      "Gr&aacute;fico de barras apiladas": makeC3Chart({
        type: "bar",
        stacked: true
      }),
      "Gr&aacute;fico de l&iacute;neas": makeC3Chart(),
      "Gr&aacute;fico de &aacute;rea": makeC3Chart({
        type: "area",
        stacked: true
      }),
