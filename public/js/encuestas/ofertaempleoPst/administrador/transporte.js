var situr = angular.module("adminPst.transporte", []);

situr.controller('caracterizacionTransporteCtrl', ['$scope','transporteServiPst', function ($scope,transporteServiPst) {
    ...
    $scope.$watch('id', function () {
        ...
        if ($scope.id != null) {
            ...
            transporteServiPst.getCaracterizacionTransporte($scope.id).then(function (data) {
    ...
    $scope.guardar = function () {
        ...
        $("body").attr("class", "charging");
        transporteServiPst.guardarCaracterizacionTransporte($scope.transporte).then(function (data) {
...
situr.controller('ofertaTransporteCtrl', ['$scope','transporteServiPst', function ($scope,transporteServiPst) {
    ...
    $scope.$watch('id', function () {
        ...
        if ($scope.id != null) {
            $("body").attr("class", "charging");
            transporteServiPst.getOfertaTransporte($scope.id).then(function (data) {
    ...
    $scope.guardar = function () {
        ...
        $scope.transporte.id = $scope.id;
        $("body").attr("class", "charging");
        transporteServiPst.guardarOfertaTransporte($scope.transporte).then(function (data) {
            if (data.success == true) {
                $("body").attr("class", "cbp-spmenu-push")
                swal({
                  title: "Realizado",
