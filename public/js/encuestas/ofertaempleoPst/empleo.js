angular.module('empleoPst.Empleo', [])

.controller('empleoMensual', ['$scope', 'ofertaServiPst',function ($scope, ofertaServiPst){
    $scope.empleo = {};
    $scope.url = "";
    ...
    $scope.$watch('id', function () {
        $("body").attr("class", "cbp-spmenu-push charging")
         ofertaServiPst.cargarDatosEmplMensual($scope.id).then(function (data) {
    ...
    $scope.guardar = function () {
        ...
        if ($scope.empleoForm.$valid && $scope.validacion()) {
            ...
            $("body").attr("class", "cbp-spmenu-push charging")
               ...
               ofertaServiPst.guardarEmpleoMensual($scope.empleo).then(function (data) {
                $("body").attr("class", "cbp-spmenu-push");
...
/*.controller('numeroEmpleados',  ['$scope', 'ofertaServiPst',function ($scope, ofertaServiPst){
    $scope.empleo = {};


$scope.$watch('id', function () {
        $("body").attr("class", "cbp-spmenu-push charging")
         ofertaServiPst.cargarDatosNumEmp($scope.id).then(function (data) {
                $("body").attr("class", "cbp-spmenu-push")
                $scope.empleo = data.empleo;
    ...
    $scope.guardar = function () {
        ...
        if ($scope.empleoForm.$valid) {
            ...
            ofertaServiPst.guardarNumeroEmp($scope.empleo).then(function (data) {
                $("body").attr("class", "cbp-spmenu-push");
                if (data.success == true) {
                    swal({
                        title: "Realizado",
...
.controller('empleoCaracterizacion',  ['$scope', 'ofertaServiPst',function ($scope, ofertaServiPst) {
    $scope.empleo = {};
    
   $scope.$watch('id', function () {
        $("body").attr("class", "cbp-spmenu-push charging")
         ofertaServiPst.cargarDatosEmplCaract($scope.id).then(function (data) {
                 $("body").attr("class", "cbp-spmenu-push")
   ...
   $scope.validar = function(){
    ...
    $scope.guardar = function () {
        ...
        if ($scope.empleoForm.$valid && !$scope.validar()) {
            $("body").attr("class", "cbp-spmenu-push charging")
                ofertaServiPst.guardarEmpCaracterizacion($scope.empleo).then(function (data) {
                $("body").attr("class", "cbp-spmenu-push");
                if (data.success == true) {
                    swal({
                        title: "Realizado",
...
.controller('empleo', ['$scope', 'ofertaServiPst',function ($scope, ofertaServiPst){
    $scope.empleo = {};
    $scope.url = "";
    $scope.dataTable = "<th>M</th> <th>F</th>"; 
    ...
    $scope.$watch('id', function () {
        $("body").attr("class", "cbp-spmenu-push charging")
         ofertaServiPst.cargarDatosEmplomensual($scope.id).then(function (data) {
                 $("body").attr("class", "cbp-spmenu-push")
                $scope.empleo = data.empleo;
                $scope.proveedor =data.proveedor;
                if($scope.empleo.VacanteOperativo == null){
    ...
    $scope.guardar = function () {
        ...
        if ($scope.empleoForm.$valid && $scope.validacion()) {
            ...
            $("body").attr("class", "cbp-spmenu-push charging")
               ...
               ofertaServiPst.guardarEmpleo($scope.empleo).then(function (data) {
                $("body").attr("class", "cbp-spmenu-push");
                if (data.success == true) {
                    swal({
                        title: "Realizado",
