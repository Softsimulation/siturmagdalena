var app = angular.module('appEncuestaAlojamientoPst', ["OfertaEmpleoServicesPst"] );

app.controller("CaracterizacionAlojamientoCtrl", function($scope, OfertaEmpleoServiPst){
    ...
    OfertaEmpleoServiPst.getDataAlojamiento( $("#id").val() ).then(function(data){
    ...
    $scope.guardar = function(){
        ...
        OfertaEmpleoServiPst.guardarCaracterizacionAlojamiento( data ).then(function(data){
...
app.controller("OfertaAlojamientoCtrl", function($scope, OfertaEmpleoServiPst){
    ...
    $scope.guardar = function(){
        ...
        OfertaEmpleoServiPst.guardarOfertaAlojamiento( data ).then(function(data){
...
app.controller("AlojamientoMensualCtrl", function($scope, OfertaEmpleoServiPst){
    ...
    $scope.guardar = function(){
        ...
        OfertaEmpleoServiPst.guardarAlojamientoMensual( data ).then(function(data){
