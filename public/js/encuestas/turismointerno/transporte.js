...
.controller('transporte', function ($scope, $http) {
    ...
    $scope.$watch('id', function () {
        ...
        $http.get('/EncuestaInterno/CargarTransporte/'+$scope.id)
    ...
    $scope.guardar = function () {
        ...
        $("body").attr("class", "cbp-spmenu-push charging")
        $http.post('/EncuestaInterno/GuardarTransporte', $scope.transporte)
            .success(function (data) {
                $("body").attr("class", "cbp-spmenu-push")
                if (data.success) {
                    var msj
                    ...
                    setTimeout(function () {
                        window.location.href = "/EncuestaInterno/Gastos/"+$scope.id;
                    }, 1000);
                } else {
...
.controller('fuentesInterno', function ($scope, $http) {
    ...
    $scope.$watch('id', function () {
        $("body").attr("class", "cbp-spmenu-push charging")
        $http.get('/EncuestaInterno/CargarDatosFuentes/'+$scope.id)
            .success(function (data) {
                $("body").attr("class", "cbp-spmenu-push")
    ...
    $scope.guardar = function() {
        ...
        $("body").attr("class", "cbp-spmenu-push charging")
        $http.post('/EncuestaInterno/GuardarFuentesInformacion', $scope.enteran)
            .success(function (data) {
                $("body").attr("class", "cbp-spmenu-push")
                if (data.success) {
                    var msj
