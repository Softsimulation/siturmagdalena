...
/**
 * @property DEstablecimientoComercial $dEstablecimientoComercial
 ...
 * @property integer $id
 * @property int $establecimiento_comercial_id
 ...
 */
class H_Duracion_Media_Estancia_Establecimiento_Comercial extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'h_duracion_media_estancia_establecimiento_comercial';
     ...
     * @var array
     */
    protected $fillable = ['establecimiento_comercial_id', 'estratos_id', 'motivo_viaje_id', 'municipios_magdalena_id', 'nivel_educacion_id', 'rango_edad_id', 'sexo_id', 'tiempo_interno_id', 'media_acotada', 'cantidad', 'media', 'mediana', 'moda', 'es_interno'];

    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function dEstablecimientoComercial()
    {
        return $this->belongsTo('App\DEstablecimientoComercial', 'establecimiento_comercial_id');
    }
