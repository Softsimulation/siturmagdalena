...
/**
 * @property DProcedenciaTuristum $dProcedenciaTuristum
 ...
 * @property integer $id
 * @property int $procedencia_turista_id
 ...
 */
class H_Servicio_Turistico_Agencia extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'h_servicios_turisticos_agencias';
     ...
     * @var array
     */
    protected $fillable = ['procedencia_turista_id', 'tiempo_id', 'tipo_proveedor_id', 'ubicacion_proveedor', 'frecuencia', 'tamaño_empresa_id', 'created_at', 'updated_at', 'user_create', 'user_update', 'estado'];

    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function dProcedenciaTuristum()
    {
        return $this->belongsTo('App\DProcedenciaTuristum', 'procedencia_turista_id');
    }
