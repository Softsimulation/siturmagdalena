 ...
 */
class H_Medio_Transporte_Interno_Emisor extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'h_medio_transporte_interno_emisor';

    /**
     * @var array
     */
    protected $fillable = ['estrato_id', 'motivo_viaje_id', 'municipio_magdalena_id', 'nivel_educacion_id', 'rango_edad_id', 'sexo_id', 'tiempo_interno_id', 'tipos_transporte_id', 'frecuencia', 'es_interno', 'user_create', 'user_update', 'estado', 'created_at', 'updated_at'];
